...
public class BatchEngineImportTaskPersistenceImpl
	...
	public BatchEngineImportTask updateImpl(
		...
		if (userId > 0) {
			...
			long batchEngineImportTaskId = 0;

			if (!isNew) {
				batchEngineImportTaskId = batchEngineImportTask.getPrimaryKey();
			}
			...
			try {
				batchEngineImportTask.setErrorMessage(
					SanitizerUtil.sanitize(
						...
						batchEngineImportTaskId, ContentTypes.TEXT_PLAIN,
						Sanitizer.MODE_ALL,
						batchEngineImportTask.getErrorMessage(), null));
			}
