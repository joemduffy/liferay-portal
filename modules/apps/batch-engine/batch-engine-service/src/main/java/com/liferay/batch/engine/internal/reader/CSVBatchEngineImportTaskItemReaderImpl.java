...
public class CSVBatchEngineImportTaskItemReaderImpl
	...
	public Map<String, Object> read() throws Exception {
		...
		if (_enclosingCharacter != null) {
			regex =
//			escapedDelimiter + "(?=(?:[^\"|']*[\"|'][^\"|']*[\"|'])*[^\"|']*$)";
			StringBundler.concat(escapedDelimiter,
				StringPool.OPEN_PARENTHESIS, StringPool.QUESTION,
				StringPool.EQUAL, StringPool.OPEN_PARENTHESIS,
				StringPool.QUESTION, StringPool.COLON,
				StringPool.OPEN_BRACKET, StringPool.CARET,
				_enclosingCharacter, StringPool.CLOSE_BRACKET,
				StringPool.STAR, _enclosingCharacter,
				StringPool.OPEN_BRACKET, StringPool.CARET,
				_enclosingCharacter, StringPool.CLOSE_BRACKET,
				StringPool.STAR, _enclosingCharacter,
				StringPool.CLOSE_PARENTHESIS, StringPool.STAR,
				StringPool.OPEN_BRACKET, StringPool.CARET,
				_enclosingCharacter, StringPool.CLOSE_BRACKET,
				StringPool.CLOSE_PARENTHESIS, StringPool.STAR,
				StringPool.OPEN_BRACKET, StringPool.CARET,
				_enclosingCharacter, StringPool.CLOSE_BRACKET,
				StringPool.STAR, StringPool.DOLLAR,
